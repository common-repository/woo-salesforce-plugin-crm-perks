...
<div class="crm_clear"></div> 
  ...
  <div class="description" style="float: none; width: 90%"><?php esc_html_e('You can Override Parimary key with your custom key, you set multiple fields as Primary key e.g Title+email+custom_text', 'woocommerce-salesforce-crm'); ?></div>
  </div>
  <div class="clear"></div>
  </div>
